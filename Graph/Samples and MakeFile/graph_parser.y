...
ud_graph:	ID ASSIGN UDGRAPHSIGN COLON CURLYOPENING ud_conn_list CURLYCLOSING
			...
			| ID ASSIGN UDGRAPHSIGN CURLYOPENING conn_list CURLYCLOSING {yyerror("Missing colon in graph definition!");}
...
d_graph:	ID ASSIGN DGRAPHSIGN COLON CURLYOPENING d_conn_list CURLYCLOSING
			...
			| ID ASSIGN DGRAPHSIGN CURLYOPENING conn_list CURLYCLOSING {yyerror("Missing colon in graph definition!");}
